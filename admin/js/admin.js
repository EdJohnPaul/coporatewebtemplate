$(document).ready(function () {
    ...
    $.Mustache.load("templates/admintemplate.html").done(function(){
        Path.map("#/home-admin").to(function(){
            window.scrollTo(0, 0);
        ...
        Path.map("#/about-admin").to(function(){
            window.scrollTo(0, 0);
        ...
        Path.map("#/contact-admin").to(function(){
            window.scrollTo(0, 0);            
        ...
        Path.map("#/services-admin").to(function(){
            window.scrollTo(0,0);
